...
import com.commuto.interfacemobile.kmService.kmTypes.*
...
class XPlatCryptoCompatibility {
    ...
    fun testPrintSymmetricallyEncryptedMsg() {
        ...
        println("Key B64:\n" + Base64.encodeToString(key.keyBytes, Base64.DEFAULT))
        val encryptedData: SymmetricallyEncryptedData = key.encrypt("test".toByteArray())
        println("Encrypted Data B64:\n" + Base64.encodeToString(encryptedData.encryptedData, Base64.DEFAULT))
    ...
    fun testSymmetricDecryption() {
        ...
        val initializationVector = Base64.decode(initializationVectorB64, Base64.DEFAULT)
    ...
    fun testPrintSignature() {
        ...
        println(Base64.encodeToString(keyPair.pubKeyToPkcs1Bytes(), Base64.DEFAULT))
    ...
    fun testVerifySignature() {
        val signedData = Base64.decode("//50AGUAcwB0AA==", Base64.DEFAULT)
        ...
        val pubKey: JavaSecPubKey = PublicKey(Base64.decode(pubKeyB64, Base64.DEFAULT)).publicKey
    ...
    fun testPrintEncryptedMessage() {
        ...
        println(Base64.encodeToString(keyPair.privKeyToPkcs1Bytes(), Base64.DEFAULT))
    ...
    fun testDecryptMessage() {
        ...
        val pubKey: JavaSecPubKey = PublicKey(Base64.decode(pubKeyB64, Base64.DEFAULT)).publicKey
        val privKey: PrivateKey = KeyPair(Base64.decode(pubKeyB64, Base64.DEFAULT),
            Base64.decode(privKeyB64, Base64.DEFAULT)).keyPair.private
