...
open class DatabaseService(
    ...
    /**
     * Updates the [Offer.approveToOpenState] property of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param state The new value of the offer's [Offer.approveToOpenState] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateOfferApproveToOpenState(offerID: String, chainID: String, state: String) {
        withContext(databaseServiceContext) {
            database.updateOfferApproveToOpenState(offerID, chainID, state)
        }
        Log.i(logTag, "updateOfferApproveToOpenState: set value to $state for offer with B64 ID $offerID, if " +
                "present")
    }

    /**
     * Updates the [Offer.approveToOpenTransactionHash], [Offer.approveToOpenTransactionCreationTime] and
     * [Offer.approveToOpenTransactionCreationBlockNumber] properties of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param transactionHash The new value of the offer's [Offer.approveToOpenTransactionHash] property, as a
     * transaction hash as a hexadecimal string with "0x" prefix.
     * @param creationTime The new value of the offer's [Offer.approveToOpenTransactionCreationTime] property.
     * @param blockNumber The new value of the offer's [Offer.approveToOpenTransactionCreationBlockNumber] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateOfferApproveToOpenData(
        offerID: String,
        chainID: String,
        ...
        withContext(databaseServiceContext) {
            database.updateOfferApproveToOpenData(
                offerID = offerID,
                chainID = chainID,
        ...
        Log.i(logTag, "updateOfferApproveToOpenData: set values to $transactionHash, $creationTime and " +
                "$blockNumber for offer with B64 ID $offerID, if present")
    }

    /**
     * Updates the [Offer.openingOfferState] property of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param state The new value of the offer's [Offer.openingOfferState] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateOpeningOfferState(offerID: String, chainID: String, state: String) {
        withContext(databaseServiceContext) {
            database.updateOpeningOfferState(offerID, chainID, state)
        }
        Log.i(logTag, "updateOpeningOfferState: set value to $state for offer with B64 ID $offerID, if present")
    }

    /**
     * Updates the [Offer.openingOfferTransactionHash], [Offer.openingOfferTransactionCreationTime] and
     * [Offer.openingOfferTransactionCreationBlockNumber] properties of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param transactionHash The new value of the offer's [Offer.openingOfferTransactionHash] property, as a
     * transaction hash as a hexadecimal string with "0x" prefix.
     * @param creationTime The new value of the offer's [Offer.openingOfferTransactionCreationTime] property.
     * @param blockNumber The new value of the offer's [Offer.openingOfferTransactionCreationBlockNumber] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateOpeningOfferData(
        offerID: String,
        chainID: String,
        transactionHash: String?,
        creationTime: String?,
        ...
        withContext(databaseServiceContext) {
            database.updateOpeningOfferData(
                offerID = offerID,
                chainID = chainID,
                transactionHash = transactionHash,
                creationTime = creationTime,
        ...
        Log.i(logTag, "updateOpeningOfferData: set values to $transactionHash, $creationTime and $blockNumber " +
                "for offer with B64 ID $offerID, if present")
    }
    ...
    /**
     * Updates the [Offer.approveToTakeState] property of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param state The new value of the offer's [Offer.approveToTakeState] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateOfferApproveToTakeState(offerID: String, chainID: String, state: String) {
        withContext(databaseServiceContext) {
            database.updateOfferApproveToTakeState(offerID, chainID, state)
        }
        Log.i(logTag, "updateOfferApproveToTakeState: set value to $state for offer with B64 ID $offerID, if " +
                "present")
    }

    /**
     * Updates the [Offer.approveToTakeTransactionHash], [Offer.approveToTakeTransactionCreationTime] and
     * [Offer.approveToTakeTransactionCreationBlockNumber] properties of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param transactionHash The new value of the offer's [Offer.approveToTakeTransactionHash] property, as a
     * transaction hash as a hexadecimal string with "0x" prefix.
     * @param creationTime The new value of the offer's [Offer.approveToTakeTransactionCreationTime] property.
     * @param blockNumber The new value of the offer's [Offer.approveToTakeTransactionCreationBlockNumber] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateOfferApproveToTakeData(
        offerID: String,
        chainID: String,
        transactionHash: String?,
        creationTime: String?,
        ...
        withContext(databaseServiceContext) {
            database.updateOfferApproveToTakeData(
                offerID = offerID,
                chainID = chainID,
                transactionHash = transactionHash,
                creationTime = creationTime,
        ...
        Log.i(logTag, "updateOfferApproveToTakeData: set values to $transactionHash, $creationTime and " +
                "$blockNumber for offer with B64 ID $offerID, if present")
    }

    /**
     * Updates the [Offer.takingOfferState] property of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param state The new value of the offer's [Offer.takingOfferState] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateTakingOfferState(offerID: String, chainID: String, state: String) {
        withContext(databaseServiceContext) {
            database.updateTakingOfferState(offerID, chainID, state)
        }
        Log.i(logTag, "updateTakingOfferState: set value to $state for offer with B64 ID $offerID, if present")
    }

    /**
     * Updates the [Offer.takingOfferTransactionHash], [Offer.takingOfferTransactionCreationTime] and
     * [Offer.takingOfferTransactionCreationBlockNumber] properties of a persistently stored
     * [Offer](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#offer) with the specified [offerID] and
     * [chainID].
     *
     * @param offerID The ID of the offer to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the offer to be updated, as a [String].
     * @param transactionHash The new value of the offer's [Offer.takingOfferTransactionHash] property, as a
     * transaction hash as a hexadecimal string with "0x" prefix.
     * @param creationTime The new value of the offer's [Offer.takingOfferTransactionCreationTime] property.
     * @param blockNumber The new value of the offer's [Offer.takingOfferTransactionCreationBlockNumber] property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateTakingOfferData(
        offerID: String,
        chainID: String,
        transactionHash: String?,
        creationTime: String?,
        ...
        withContext(databaseServiceContext) {
            database.updateTakingOfferData(
                offerID = offerID,
                chainID = chainID,
                transactionHash = transactionHash,
                creationTime = creationTime,
        ...
        Log.i(logTag, "updateTakingOfferData: set values to $transactionHash, $creationTime and $blockNumber " +
                "for offer with B64 ID $offerID, if present")
    }
    ...
    /**
     * Updates the [Swap.reportPaymentReceivedState] property of a persistently stored
     * [Swap](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#swap) with the specified [swapID] and
     * [chainID].
     *
     * @param swapID The ID of the swap to be updated, as a Base64-[String] of bytes.
     ...
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateReportPaymentReceivedState(swapID: String, chainID: String, state: String) {
        withContext(databaseServiceContext) {
            database.updateReportPaymentReceivedState(swapID, chainID, state)
        }
        Log.i(logTag, "updateReportPaymentReceivedState: set value to $state for offer with B64 ID $swapID, if " +
                "present")
    }

    /**
     * Updates the [Swap.reportPaymentReceivedTransactionHash], [Swap.reportPaymentReceivedTransactionCreationTime] and
     * [Swap.reportPaymentReceivedTransactionCreationBlockNumber] properties of a persistently stored
     * [Swap](https://www.commuto.xyz/docs/technical-reference/core-tec-ref#swap) with the specified [swapID] and
     * [chainID].
     *
     * @param swapID The ID of the swap to be updated, as a Base64-[String] of bytes.
     * @param chainID The blockchain ID of the swap to be updated, as a [String].
     * @param transactionHash The new value of the swap's [Swap.reportPaymentReceivedTransactionHash] property, as a
     * transaction hash as a hexadecimal string with "0x" prefix.
     * @param creationTime The new value of the swap's [Swap.reportPaymentReceivedTransactionCreationTime] property.
     * @param blockNumber The new value of the swap's [Swap.reportPaymentReceivedTransactionCreationBlockNumber]
     * property.
     */
    @OptIn(DelicateCoroutinesApi::class)
    suspend fun updateReportPaymentReceivedData(
        swapID: String,
        chainID: String,
        transactionHash: String?,
        creationTime: String?,
        ...
        withContext(databaseServiceContext) {
            database.updateReportPaymentReceivedData(
                swapID = swapID,
                chainID = chainID,
                transactionHash = transactionHash,
                creationTime = creationTime,
        ...
        Log.i(logTag, "updateReportPaymentReceivedData: set values to $transactionHash, $creationTime and " +
                "$blockNumber for offer with B64 ID $swapID, if present")
    }
    ...
    suspend fun getSwap(id: String): Swap? {
        ...
        return if (dbSwaps.size > 1) {
            ...
            Swap(
                ...
                reportPaymentReceivedState = dbSwaps[0].reportPaymentReceivedState,
                reportPaymentReceivedTransactionHash = dbSwaps[0].reportPaymentReceivedTransactionHash,
