...
/**
 * An interface that a class must implement in order to be notified of offer-related messages by [P2PService].
 */
interface OfferMessageNotifiable {
     ...
     *
     * @param message The new [PublicKeyAnnouncement] of which the class implementing this interface is being notified
