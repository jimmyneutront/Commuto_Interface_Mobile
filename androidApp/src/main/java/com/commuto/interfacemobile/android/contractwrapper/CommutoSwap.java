...
public class CommutoSwap extends Contract {
    ...
    public static class Offer extends DynamicStruct {
        ...
        public Offer(Boolean isCreated, Boolean isTaken, String maker, byte[] interfaceId, String stablecoin, BigInteger amountLowerBound, BigInteger amountUpperBound, BigInteger securityDepositAmount, BigInteger serviceFeeRate, BigInteger direction, byte[] price, List<byte[]> settlementMethods, BigInteger protocolVersion) {
            /*
            Generated by web3j-cli, but creates a "Cannot resolve constructor" error:
            super(new org.web3j.abi.datatypes.Bool(isCreated),new org.web3j.abi.datatypes.Bool(isTaken),new org.web3j.abi.datatypes.Address(maker),new org.web3j.abi.datatypes.DynamicBytes(interfaceId),new org.web3j.abi.datatypes.Address(stablecoin),new org.web3j.abi.datatypes.generated.Uint256(amountLowerBound),new org.web3j.abi.datatypes.generated.Uint256(amountUpperBound),new org.web3j.abi.datatypes.generated.Uint256(securityDepositAmount),new org.web3j.abi.datatypes.generated.Uint256(serviceFeeRate),new org.web3j.abi.datatypes.generated.Uint8(direction),new org.web3j.abi.datatypes.DynamicBytes(price),new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.DynamicBytes>(settlementMethods),new org.web3j.abi.datatypes.generated.Uint256(protocolVersion));
             */
            super(new org.web3j.abi.datatypes.Bool(isCreated),new org.web3j.abi.datatypes.Bool(isTaken),new org.web3j.abi.datatypes.Address(maker),new org.web3j.abi.datatypes.DynamicBytes(interfaceId),new org.web3j.abi.datatypes.Address(stablecoin),new org.web3j.abi.datatypes.generated.Uint256(amountLowerBound),new org.web3j.abi.datatypes.generated.Uint256(amountUpperBound),new org.web3j.abi.datatypes.generated.Uint256(securityDepositAmount),new org.web3j.abi.datatypes.generated.Uint256(serviceFeeRate),new org.web3j.abi.datatypes.generated.Uint8(direction),new org.web3j.abi.datatypes.DynamicBytes(price),new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.DynamicBytes>(buildDynamicBytesArrList(settlementMethods)),new org.web3j.abi.datatypes.generated.Uint256(protocolVersion));
        ...
        public Offer(Bool isCreated, Bool isTaken, Address maker, DynamicBytes interfaceId, Address stablecoin, Uint256 amountLowerBound, Uint256 amountUpperBound, Uint256 securityDepositAmount, Uint256 serviceFeeRate, Uint8 direction, DynamicBytes price, DynamicArray<DynamicBytes> settlementMethods, Uint256 protocolVersion) {
            super(isCreated,isTaken,maker,interfaceId,stablecoin,amountLowerBound,amountUpperBound,securityDepositAmount,serviceFeeRate,direction,price,settlementMethods,protocolVersion);
    ...
    public static class Swap extends DynamicStruct {
        ...
        public Swap(Bool isCreated, Bool requiresFill, Address maker, DynamicBytes makerInterfaceId, Address taker, DynamicBytes takerInterfaceId, Address stablecoin, Uint256 amountLowerBound, Uint256 amountUpperBound, Uint256 securityDepositAmount, Uint256 takenSwapAmount, Uint256 serviceFeeAmount, Uint256 serviceFeeRate, Uint8 direction, DynamicBytes price, DynamicBytes settlementMethod, Uint256 protocolVersion, Bool isPaymentSent, Bool isPaymentReceived, Bool hasBuyerClosed, Bool hasSellerClosed, Uint8 disputeRaiser) {
            super(isCreated,requiresFill,maker,makerInterfaceId,taker,takerInterfaceId,stablecoin,amountLowerBound,amountUpperBound,securityDepositAmount,takenSwapAmount,serviceFeeAmount,serviceFeeRate,direction,price,settlementMethod,protocolVersion,isPaymentSent,isPaymentReceived,hasBuyerClosed,hasSellerClosed,disputeRaiser);
            this.isCreated = isCreated.getValue();
